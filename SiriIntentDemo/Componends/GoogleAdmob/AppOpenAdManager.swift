...
class NativeManager: NSObject, GADAdLoaderDelegate, GADNativeAdDelegate, GADNativeAdLoaderDelegate {
    ...
    func setAdsView() {
        ...
        NSLayoutConstraint.activate([
            adsView.leadingAnchor.constraint(equalTo: rootViewController.view.leadingAnchor, constant: +10),
            adsView.trailingAnchor.constraint(equalTo: rootViewController.view.trailingAnchor, constant: -10),
        ...
        UIView.animate(withDuration: 1, animations: {
            ...
            DispatchQueue.main.async { [self] in
                ...
                if let iconImage = nativeAd.icon?.image {
                    ...
                    (nativeAdView.headlineView as? UILabel)?.widthAnchor.constraint(equalToConstant: 180).isActive = true
                }
