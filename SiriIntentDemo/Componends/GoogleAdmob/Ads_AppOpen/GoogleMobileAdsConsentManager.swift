...
class GoogleMobileAdsConsentManager: NSObject {
    ...
    func gatherConsent(
        ...
        consentGatheringComplete: @escaping (Error?, Bool) -> Void
    ) {
        ...
        UMPConsentInformation.sharedInstance.requestConsentInfoUpdate(with: parameters) {
            ...
            guard requestConsentError == nil else {
                return consentGatheringComplete(requestConsentError, false)
            }
            ...
            UMPConsentForm.loadAndPresentIfRequired(from: consentFormPresentationviewController) {
                ...
                consentGatheringComplete(loadAndPresentError, true)
            }
        }
    }
